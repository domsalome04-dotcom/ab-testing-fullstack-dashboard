...
const hrHRGrid = {
  ...
  columnMenuAriaLabel: columnName => `Izbornik stupca ${columnName}`,
  ...
  paginationDisplayedRows: ({
    ...
    const estimatedLabel = estimated && estimated > to ? `oko ${formatNumber(estimated)}` : `više nego ${formatNumber(to)}`;
