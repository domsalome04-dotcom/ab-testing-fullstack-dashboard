...
const ukUAGrid = {
  ...
  paginationDisplayedRows: ({
    ...
    if (!estimated) {
      return `${(0, _getGridLocalization.formatNumber)(from)}–${(0, _getGridLocalization.formatNumber)(to)} з ${!unknownRowCount ? (0, _getGridLocalization.formatNumber)(count) : `більше ніж ${(0, _getGridLocalization.formatNumber)(to)}`}`;
    }
    const estimatedLabel = estimated && estimated > to ? `близько ${(0, _getGridLocalization.formatNumber)(estimated)}` : `більше ніж ${(0, _getGridLocalization.formatNumber)(to)}`;
    return `${(0, _getGridLocalization.formatNumber)(from)}–${(0, _getGridLocalization.formatNumber)(to)} з ${!unknownRowCount ? (0, _getGridLocalization.formatNumber)(count) : estimatedLabel}`;
  },
