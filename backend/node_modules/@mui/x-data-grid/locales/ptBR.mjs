...
const ptBRGrid = {
  ...
  paginationDisplayedRows: ({
    ...
    if (!estimated) {
      return `${formatNumber(from)}–${formatNumber(to)} de ${count !== -1 ? formatNumber(count) : `mais de ${formatNumber(to)}`}`;
    }
    const estimatedLabel = estimated && estimated > to ? `cerca de ${formatNumber(estimated)}` : `mais de ${formatNumber(to)}`;
