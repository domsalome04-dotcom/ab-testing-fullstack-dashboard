...
function findGridCellElementsFromCol(col, api) {
  ...
  if (!root) {
    throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: The root element is not found.' : (0, _formatErrorMessage2.default)(58));
  }
...
function findGridCells(api, field) {
  ...
  return Array.from(container.querySelectorAll(`:scope > div > div > div > div > [data-field="${escapeOperandAttributeSelector(field)}"]:is([role="gridcell"], [role="rowheader"])`));
}
