...
exports.MAX_ANCHOR_BLOCKS = exports.ANCHOR_BLOCK = void 0;
exports.nextAnchorTop = nextAnchorTop;
/**
 ...
 */
const ANCHOR_BLOCK = exports.ANCHOR_BLOCK = 40_000;

/**
 * Hard cap on the pad, counted in `ANCHOR_BLOCK`s.
 */
const MAX_ANCHOR_BLOCKS = exports.MAX_ANCHOR_BLOCKS = 5;
const MAX_ANCHOR_PAD = ANCHOR_BLOCK * MAX_ANCHOR_BLOCKS;
function quantizeAnchor(offsetTop) {
 ...
 */
function nextAnchorTop(anchorTop, offsetTop, isSettled) {
