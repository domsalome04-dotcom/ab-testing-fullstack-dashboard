 ...
 * ```
 */
export class LayoutListSticky extends Layout {
  ...
  static selectors = {
    ...
    windowProps: createSelectorMemoized(Virtualization.selectors.renderContext, Dimensions.selectors.rowPositions, Dimensions.selectors.contentHeight, Dimensions.selectors.dimensions, (renderContext, rowPositions, contentHeight, dimensions) => {
    ...
    windowContentProps: createSelectorMemoized(Virtualization.selectors.offsetTop, Virtualization.selectors.anchorTop, (offsetTop, anchorTop) => {
 ...
 */
const horizontalGeometry = createSelectorMemoized(Virtualization.selectors.renderContext, Dimensions.selectors.dimensions, Dimensions.selectors.columnPositions, (renderContext, dimensions, columnPositions, _columns) => {
  const {
    leftPinnedWidth,
    rightPinnedWidth,
    columnsTotalWidth,
 ...
 */
const verticalGeometry = createSelectorMemoized(Virtualization.selectors.renderContext, Dimensions.selectors.rowPositions, Dimensions.selectors.contentHeight, Dimensions.selectors.dimensions, Virtualization.selectors.anchorTop, (renderContext, rowPositions, contentHeight, dimensions, anchorTop) => {
  const {
    viewportInnerSize,
    topContainerHeight,
    bottomContainerHeight
...
export class LayoutGridSticky extends Layout {
  ...
  static selectors = {
    ...
    scrollerProps: createSelectorMemoized(Virtualization.selectors.context, Dimensions.selectors.autoHeight, (context, autoHeight) => ({
      ref: context.scrollerRef,
      style: {
        width: '100%',
        height: '100%',
    ...
    scrollbarHorizontalProps: createSelectorMemoized(Virtualization.selectors.context, context => ({
      ref: context.scrollbarHorizontalRef
    })),
    // Horizontal offset spacer: gives the sticky sibling leftward slack to clamp into
    // (the horizontal analog of `spacerTop`).
    spacerLeftProps: createSelectorMemoized(horizontalGeometry, (geometry, _columns) => ({
      style: {
    ...
    innerContainerProps: createSelectorMemoized(horizontalGeometry, (geometry, _columns) => ({
      style: {
    ...
    spacerBottomProps: createSelectorMemoized(verticalGeometry, Dimensions.selectors.contentHeight, (geometry, contentHeight) => ({
      style: {
    ...
    innerWindowProps: createSelectorMemoized(horizontalGeometry, verticalGeometry, (horizontal, vertical, _columns) => ({
      style: {
